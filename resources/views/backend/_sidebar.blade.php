<nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar="init" style="">
  <div class="simplebar-wrapper" style="margin: 0px;">
          ...
          <div class="simplebar-content" style="padding: 0px;">
            <div class="sidebar-inner px-4 pt-3">
              <div
                ...
                <div class="collapse-close d-md-none">
                  <a href="#sidebarMenu" data-bs-toggle="collapse" data-bs-target="#sidebarMenu"
                    aria-controls="sidebarMenu" aria-expanded="false" aria-label="Toggle navigation" class="collapsed">
              ...
              <ul class="nav flex-column pt-3 pt-md-0">
                ...
                @endif
                <li class="nav-item {{request()->routeIs('bets')?'active':''}}">
                  <a href="{{route("bets")}}" class="nav-link">
                    <span class="sidebar-icon">
                      <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span class="sidebar-text">Bets</span>
                  </a>
                </li>

                <li class="nav-item {{request()->routeIs('bets.history')?'active':''}}">
                  <a href="{{route("bets.history")}}" class="nav-link">
                    <span class="sidebar-icon">
                      <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd"
                ...
                <li class="nav-item {{request()->routeIs('report.*')?'':'collapsed'}}">
                  <span class="nav-link d-flex justify-content-between align-items-center" data-bs-toggle="collapse"
                    data-bs-target="#submenu-reports" aria-expanded="{{request()->routeIs('report.*')?'true':'false'}}">
                    <span>
                      <span class="sidebar-icon">
                        <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                          xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div class="multi-level collapse {{request()->routeIs('report.*')?'show':''}}" role="list"
                    id="submenu-reports" aria-expanded="false" style="">
                    <ul class="flex-column nav">
                      <li class="nav-item {{request()->routeIs('report.users')?'active':''}}">
                        <a class="nav-link" href="{{route("report.users")}}">
                          <span class="sidebar-text">Users</span>
                        </a>
                      </li>
                    </ul>
    ...
    <div class="simplebar-placeholder" style="width: 260px; height: 615px;"></div>
  </div>
